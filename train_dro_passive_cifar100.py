...
if __name__=="__main__":
    ...
    X_train_pos, X_train_neg = np.load("Dataset/Cifar100/X_train_pos.npy", allow_pickle = True), np.load("Dataset/Cifar100/X_train_neg.npy", allow_pickle = True)
    y_train_pos, y_train_neg = np.load("Dataset/Cifar100/y_train_pos.npy", allow_pickle = True), np.load("Dataset/Cifar100/y_train_neg.npy", allow_pickle = True)
    X_test_pos, X_test_neg = np.load("Dataset/Cifar100/X_test_pos.npy", allow_pickle = True), np.load("Dataset/Cifar100/X_test_neg.npy", allow_pickle = True)
    y_test_pos, y_test_neg = np.load("Dataset/Cifar100/y_test_pos.npy", allow_pickle = True), np.load("Dataset/Cifar100/y_test_neg.npy", allow_pickle = True)
    batch_size = 120
    ...
    for i in range(max_iterations):
        ...
        if i%10==0:
            ...
            if test_map>best_test_map:
                ...
                'opt_dict': optimizer.state_dict(),}, os.path.join("dro_passive/Cifar100/models/model_"+str(run)+"_"+str(gamma)+"_best.pth.tar"))
    ...
    np.save("dro_passive/Cifar100/logs/aucs_"+str(run)+"_"+str(gamma)+".npy", test_aucs)
    np.save("dro_passive/Cifar100/logs/losses_"+str(run)+"_"+str(gamma)+".npy", losses)
    np.save("dro_passive/Cifar100/logs/maps_"+str(run)+"_"+str(gamma)+".npy", test_maps)
