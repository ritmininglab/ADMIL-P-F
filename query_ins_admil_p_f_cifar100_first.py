...
if __name__=="__main__":
    ...
    if exploit_query_no>0:
        ...
        exploit_pos_data = []
        exploit_neg_data = []            
    np.save("Dataset/Cifar100/added_pos_data_"+str(run)+"_"+str(no_query)+"_admil_p_f.npy",queried_pos_data)    
    np.save("Dataset/Cifar100/added_neg_data_"+str(run)+"_"+str(no_query)+"_admil_p_f.npy", queried_neg_data)
