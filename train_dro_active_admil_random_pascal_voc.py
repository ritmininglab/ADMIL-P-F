...
if __name__=="__main__":
    ...
    patience = 0
    lab_train_pos = np.load("Dataset/Pascal_VOC/added_pos_data_"+str(run)+"_"+str(no_query)+"_admil_random.npy", allow_pickle = True)
    lab_train_neg = np.load("Dataset/Pascal_VOC/added_neg_data_"+str(run)+"_"+str(no_query)+"_admil_random.npy", allow_pickle = True)
    ...
    np.save("dro_active/Pascal_VOC/logs/aucs_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", test_aucs)
    np.save("dro_active/Pascal_VOC/logs/maps_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", test_maps)
    np.save("dro_active/Pascal_VOC/logs/dro_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", dro_losses)
    np.save("dro_active/Pascal_VOC/logs/reg_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", reg_losses)
