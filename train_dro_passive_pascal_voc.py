...
if __name__=="__main__":
    ...
    train_pos = np.load("Dataset/Pascal_VOC/train_pos.npy", allow_pickle = True)
    train_neg = np.load("Dataset/Pascal_VOC/train_neg.npy", allow_pickle = True)
    ...
    for i in range(max_iterations):
        ...
        if i%10==0:
            ...
            if test_ap>best_test_map:
                ...
                'opt_dict': optimizer.state_dict(),}, os.path.join("dro_passive/Pascal_VOC/models/model_"+str(run)+"_"+str(gamma)+"_best_map.pth.tar"))
    ...
    np.save("dro_passive/Pascal_VOC/logs/test_aucs_"+str(run)+"_"+str(gamma)+".npy", test_aucs)
    np.save("dro_passive/Pascal_VOC/logs/test_maps_"+str(run)+"_"+str(gamma)+".npy", test_maps)
    np.save("dro_passive/Pascal_VOC/logs/losses_"+str(run)+"_"+str(gamma)+".npy", losses)
