...
if __name__=="__main__":
    ...
    lab_train_pos = np.load("Dataset/20NewsGroup/rep_"+str(run)+"_topic_"+topic+"_added_pos_"+str(no_query)+"_admil_f_entropy.npy", allow_pickle = True)
    lab_train_neg = np.load("Dataset/20NewsGroup/rep_"+str(run)+"_topic_"+topic+"_added_neg_"+str(no_query)+"_admil_f_entropy.npy", allow_pickle = True)
    if len(lab_train_pos)+len(lab_train_neg)==0:
        sys.exit()
        
    if no_query!=15:
         prev_lab_train_pos = np.load("Dataset/20NewsGroup/rep_"+str(run)+"_topic_"+topic+"_added_pos_"+str(no_query-15)+"_admil_f_entropy.npy", allow_pickle = True)
         prev_lab_train_neg = np.load("Dataset/20NewsGroup/rep_"+str(run)+"_topic_"+topic+"_added_neg_"+str(no_query-15)+"_admil_f_entropy.npy", allow_pickle = True)
    ...
    np.save("dro_active/20NewsGroup/logs/test_aucs_"+str(run)+"_"+str(gamma)+"_"+str(topic)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", test_aucs)
    np.save("dro_active/20NewsGroup/logs/test_maps_"+str(run)+"_"+str(gamma)+"_"+str(topic)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", test_maps)
    np.save("dro_active/20NewsGroup/logs/dro_losses_"+str(run)+"_"+str(gamma)+"_"+str(topic)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", dro_losses)
    np.save("dro_active/20NewsGroup/logs/reg_losses_"+str(run)+"_"+str(gamma)+"_"+str(topic)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", reg_losses)
