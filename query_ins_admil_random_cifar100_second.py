...
if __name__=="__main__":
    ...
    prev_train_pos = np.load("Dataset/Cifar100/added_pos_data_"+str(run)+"_"+str(prev_query)+"_admil_random.npy", allow_pickle = True)
    prev_train_neg = np.load("Dataset/Cifar100/added_neg_data_"+str(run)+"_"+str(prev_query)+"_admil_random.npy", allow_pickle = True)
    ...
    np.save("Dataset/Cifar100/added_pos_data_"+str(run)+"_"+str(curr_query)+"_admil_random.npy",queried_pos_data)
    np.save("Dataset/Cifar100/added_neg_data_"+str(run)+"_"+str(curr_query)+"_admil_random.npy", queried_neg_data)
