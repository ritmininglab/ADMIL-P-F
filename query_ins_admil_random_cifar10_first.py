...
if __name__=="__main__":
    ...
    all_idxs = list(range(len(y_train_pos.flatten())))
    ...
    np.save("Dataset/Cifar10/added_pos_data_"+str(run)+"_"+str(no_query)+"_admil_random.npy",queried_pos_data)
    np.save("Dataset/Cifar10/added_neg_data_"+str(run)+"_"+str(no_query)+"_admil_random.npy", queried_neg_data)
