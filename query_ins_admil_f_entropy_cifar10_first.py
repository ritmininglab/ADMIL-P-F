...
if __name__=="__main__":
    ...
    np.save("Dataset/Cifar10/added_pos_data_"+str(run)+"_"+str(no_query)+"_admil_f_entropy.npy",queried_pos_data)    
    np.save("Dataset/Cifar10/added_neg_data_"+str(run)+"_"+str(no_query)+"_admil_f_entropy.npy", queried_neg_data)
