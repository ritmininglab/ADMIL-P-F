...
if __name__=="__main__":
    ...
    lab_train_pos = np.load("Dataset/Cifar10/added_pos_data_"+str(run)+"_"+str(no_query)+"_admil_p_f.npy", allow_pickle = True)
    lab_train_neg = np.load("Dataset/Cifar10/added_neg_data_"+str(run)+"_"+str(no_query)+"_admil_p_f.npy", allow_pickle = True)
    ...
    np.save("dro_active/Cifar10/logs/test_aucs_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_p_f.npy", test_aucs)
    np.save("dro_active/Cifar10/logs/test_maps_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_p_f.npy", test_maps)
    np.save("dro_active/Cifar10/logs/dro_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_p_f.npy", dro_losses)
    np.save("dro_active/Cifar10/logs/reg_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_p_f.npy", reg_losses)
