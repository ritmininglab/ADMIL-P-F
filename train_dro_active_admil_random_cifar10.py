...
if __name__=="__main__":
    ...
    X_test_pos, X_test_neg = np.load("Dataset/Cifar10/X_test_pos_"+str(2)+".npy"), np.load("Dataset/Cifar10/X_test_neg.npy")
    ...
    lab_train_pos = np.load("Dataset/Cifar10/added_pos_data_"+str(run)+"_"+str(no_query)+"_admil_random.npy", allow_pickle = True)
    lab_train_neg = np.load("Dataset/Cifar10/added_neg_data_"+str(run)+"_"+str(no_query)+"_admil_random.npy", allow_pickle = True)
    ...
    np.save("dro_active/Cifar10/logs/test_aucs_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", test_aucs)
    np.save("dro_active/Cifar10/logs/test_maps_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", test_maps)
    np.save("dro_active/Cifar10/logs/dro_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", dro_losses)
    np.save("dro_active/Cifar10/logs/reg_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_random.npy", reg_losses)
