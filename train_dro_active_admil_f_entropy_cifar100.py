...
if __name__=="__main__":
    ...
    np.save("dro_active/Cifar100/logs/test_aucs_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", test_aucs)
    np.save("dro_active/Cifar100/logs/test_maps_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", test_maps)
    np.save("dro_active/Cifar100/logs/dro_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", dro_losses)
    np.save("dro_active/Cifar100/logs/reg_losses_"+str(run)+"_"+str(gamma)+"_"+str(no_query)+"_"+str(reg_coeff)+"_admil_f_entropy.npy", reg_losses)
